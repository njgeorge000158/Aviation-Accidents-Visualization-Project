/****************************************************************************
 *
 *  File Name:  aviationAccidentsHeatmap.js
 *
 *  File Description:
 ...
 *      UpdateAccidentMapMarkersSubroutine
 * 
...
let overlayLayerGroupDictionary 
        = {
            'Heat Map': heatMapOverlayLayerGroup,
...
/****************************************************************************
 *
 *  Subroutine Name:  CreateControlMenuSubroutine
 *
 *  Subroutine Description:  
 *      This subroutine creates the control menu.
 *
 *
...
function CreateControlMenuSubroutine() 
{
    L.control
     .layers
     (   
 ...
 *      the aircraft type dropdown menu.
 *
 *
 *  Subroutines Parameters:
 *
                            ...
                            heatLocationArray
                                ...
                                (
                                    [accidentsGeoJSONDictionary.features[i].geometry.coordinates[0],
                                      ...
                                      accidentsGeoJSONDictionary.features[i].properties.fatalities / 301.0
                                     ]
                                )
                        }

                        var accidentMapHeatLayer
                                = L.heatLayer
                                    (heatLocationArray, 
                                     {
                                        minOpacity: 0.2,
                                        radius: 40,
                                        blur: 40,
                                        gradient: {0.15: 'blue', 0.25: 'green', 0.4: 'orange', 0.5: 'orangered', 0.65: 'red', 1.0: 'maroon'}
                                     }
                                    ).addTo(heatMapOverlayLayerGroup);

                        if (layerExistsBoolean == false)
                        {
                            currentMapObject.removeLayer(heatMapOverlayLayerGroup);
                        }
                        else
                        {
                            heatMapOverlayLayerGroup.addTo(currentMapObject); 
...
/****************************************************************************
 *
 *  Subroutine Name:     UpdateAccidentMapMarkersSubroutine
 *
 *  Subroutine Description:  
 *      This subroutine creates and displays the current accident markers 
 *      on the map.
 *
 *
 *  Subroutines Parameters:
...
function UpdateAccidentMapMarkersSubroutine
            (startYearString,
             endYearString,
             typesString,
             operatorsString,
    ...
    FetchJsonDataFromURLFunction 
        (routeURLString)
            ...
            (
                (accidentsGeoJSONDictionary => 
                    {
                        for (var i = 0; i < accidentsGeoJSONDictionary.features.length; i++)
                        {
                            L.marker
                            (
                                [accidentsGeoJSONDictionary.features[i].geometry.coordinates[0],
                                 accidentsGeoJSONDictionary.features[i].geometry.coordinates[1]], 
                                {icon: accidentsMarkerIconObject}
                            )
                            .bindPopup
                            (
 ...
 *
 *  Subroutine Description:  
 *      This subroutine initializes the Aviation Accidents Heatmap
 *      Toolkit by populating the drop down menus and setting up
 *      the control menu, dropdown menus, and map layers.
 *
 *
 *  Subroutine Parameters:
 *
